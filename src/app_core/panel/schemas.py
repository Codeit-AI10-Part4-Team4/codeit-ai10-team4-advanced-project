...
class TradeAreaFeatures(BaseModel):
    ...
    #: 실측(2026Q1 서울): 카페 개업 738 / 폐업 853, 한식 1,643 / 1,788 — 순감이다.
    #: ⚠️ 아인님이 추가(2026-08-11). 기본값이 있어 기존 코드를 깨지 않습니다.
    open_cnt: int = Field(default=0, ge=0)
    close_cnt: int = Field(default=0, ge=0)
