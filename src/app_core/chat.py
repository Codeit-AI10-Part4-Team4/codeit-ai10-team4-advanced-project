...
3. `still_unknown` 이 **비었으면 질문하지 마라.**
   "이제 만들어드릴게요" 하고 끝내라. options 도 빈 배열.

   비지 않았으면 그중 **맨 위 하나만** 물어라 —
   {next_action}
...
**순서를 지켜라.** extracted → still_unknown → message → options.
앞의 것을 쓰지 않고 message 부터 쓰면 이미 답한 것을 또 묻게 된다.

{{
  "extracted": {{"product": "...", "price": 숫자, "situation": "...", "tone": "...", "extra": "..."}},
  "still_unknown": ["원하는 느낌"],
  "message": "사장님에게 할 말",
  "options": ["선택지1", "선택지2"]
}}
