...
window.MOCK = {
  ...
  stores: [
    { id: 1, name: '행복한 순대국', industry: '한식음식점', industryId: 'korean_food',
      address: '서울시 은평구 불광동 56-7',  lat: 37.627586, lon: 126.927280 },
    { id: 2, name: '홍길동 분식',   industry: '분식·간이음식', industryId: 'snack',
      address: '서울 마포구 망원로 87',      lat: 37.557944, lon: 126.906382 },
    { id: 3, name: '마포 커피숍',   industry: '카페·디저트', industryId: 'cafe',
      address: '서울시 마포구 합정동 88-2',  lat: 37.544299, lon: 126.912733 },
  ],
